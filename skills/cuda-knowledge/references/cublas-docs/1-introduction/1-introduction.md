...
The legacy cuBLAS API, explained in more detail in [Using the cuBLAS Legacy API](#id124), can be used by including the header file `cublas.h`. Since the legacy API is identical to the previously released cuBLAS library API, existing applications will work out of the box and automatically use this legacy API without any source code changes.
