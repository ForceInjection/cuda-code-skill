...
**Source:** https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/troubleshooting/gpu_troubleshooting.html

---

# GPU troubleshooting[](#gpu-troubleshooting "Permalink to this heading")
...
**Peer-to-peer GPU memory access.** For GPU-to-GPU traffic, NCCL favors _peer-to-peer_ transport when CUDA reports that GPUs can access each other’s memory directly (typically over NVLink, or over PCIe when the topology and driver allow it).
