...
**Source:** https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/troubleshooting/logging.html
...
## Logging Environment Variables[](#logging-environment-variables "Permalink to this heading")

The following environment variables control NCCL logging behavior:

Variable | Description  
---|---  
[NCCL_DEBUG](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.html#nccl-debug) | Sets verbosity: VERSION, WARN, INFO, TRACE  
[NCCL_DEBUG_SUBSYS](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.html#nccl-debug-subsys) | Filters log output by subsystem  
[NCCL_DEBUG_FILE](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.html#nccl-debug-file) | Writes logs to files (%h host, %p PID)  
[NCCL_DEBUG_TIMESTAMP_FORMAT](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.html#nccl-debug-timestamp-format) | Sets timestamp format (strftime syntax)  
[NCCL_DEBUG_TIMESTAMP_LEVELS](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.html#nccl-debug-timestamp-levels) | Selects which levels include timestamps  
  
## Logging Levels[](#logging-levels "Permalink to this heading")
...
### Setting the Logging Level[](#setting-the-logging-level "Permalink to this heading")
...
### Example Output[](#example-output "Permalink to this heading")
...
## Filtering by Subsystem[](#filtering-by-subsystem "Permalink to this heading")
...
### Available Subsystems[](#available-subsystems "Permalink to this heading")
...
### Example Output by Subsystem[](#example-output-by-subsystem "Permalink to this heading")
...
## Logging to Files[](#logging-to-files "Permalink to this heading")
...
## Timestamp Configuration[](#timestamp-configuration "Permalink to this heading")

NCCL log messages can include timestamps for timing analysis.

### Timestamp Format[](#timestamp-format "Permalink to this heading")
...
### Timestamp Levels[](#timestamp-levels "Permalink to this heading")
...
## Common Debugging Scenarios[](#common-debugging-scenarios "Permalink to this heading")

### Diagnosing Initialization Hangs[](#diagnosing-initialization-hangs "Permalink to this heading")
...
### Investigating Network Issues[](#investigating-network-issues "Permalink to this heading")
...
### Understanding Topology Detection[](#understanding-topology-detection "Permalink to this heading")
...
### Debugging Performance Issues[](#debugging-performance-issues "Permalink to this heading")
...
### Tracing NCCL API Calls[](#tracing-nccl-api-calls "Permalink to this heading")
...
### Full Debugging Session[](#full-debugging-session "Permalink to this heading")
